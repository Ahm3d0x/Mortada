...
const EFFECT_OPTIONS = [
  ...
  { effect: "red_card", label: "طرد مباشر (حمراء)", effectArabic: "كارت أحمر", desc: "حكم المباراة يتدخل! قم باستبعاد أي كارت لاعب لخصمك (مكشوف أو مقلوب) ومطرود من الملعب حتى نهاية المباراة.", icon: "🟥" },
