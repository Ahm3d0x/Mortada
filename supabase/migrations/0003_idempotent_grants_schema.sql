-- =====================================================
-- Mortada Card Game - Supabase Schema (v3 - Final Production)
-- Run this in Supabase SQL Editor
-- =====================================================

-- NOTE: If you have old/mismatched tables and want a clean reset,
-- uncomment the following DROP TABLE lines before running the script:
-- DROP TABLE IF EXISTS package_special_cards CASCADE;
-- DROP TABLE IF EXISTS special_cards CASCADE;
...
DROP TRIGGER IF EXISTS update_special_cards_updated_at ON special_cards;
...
GRANT ALL ON TABLE public.packages TO anon, authenticated, service_role;
GRANT ALL ON TABLE public.cards TO anon, authenticated, service_role;
GRANT ALL ON TABLE public.package_cards TO anon, authenticated, service_role;
GRANT ALL ON TABLE public.special_cards TO anon, authenticated, service_role;
GRANT ALL ON TABLE public.package_special_cards TO anon, authenticated, service_role;
